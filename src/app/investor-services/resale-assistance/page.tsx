...
export const metadata: Metadata = {
  title: "Resale Assistance & File Transfer | Legends Marketing",
  description:
    "Secure secondary-market file buying, verification, NDC clearance, and official society transfer.",
};

const benefits = [
  "Complete verification of file authenticity and paid ledger history",
  "Clearance of all outstanding society dues and transfer taxes",
  "Biometric and official transfer facilitation at developer offices",
  "Safe funds settlement protection for both buyer and seller"
];

const processSteps = [
  {
    "step": "Analyze",
    "title": "File Record Verification",
    "desc": "Confirm file status, owner CNIC, and paid receipts in developer records."
  },
  {
    "step": "Select",
    "title": "NDC Application",
    "desc": "Obtain No Demand Certificate confirming zero outstanding dues."
  },
  {
    "step": "Book",
    "title": "Transfer Appointment",
    "desc": "Schedule official transfer at society headquarters with biometric clearance."
  },
  {
    "step": "Complete",
    "title": "Transfer Letter Delivery",
    "desc": "Collect and hand over original transfer letter to the new owner."
  }
];

export default function ResaleAssistancePage() {
  return (
    <>
        ...
        <Container>
          <div className="page-hero__inner">
            <span className="kicker" style={{ color: "var(--gold-light)" }}>
              Investor Services &middot; Safe Secondary Market
            </span>
            <h1 className="page-hero__title">Resale Assistance & File Transfer</h1>
          ...
          <div className="grid-2" style={{ alignItems: "center", gap: "3.5rem" }}>
            <div>
              ...
              <p style={{ fontSize: "1.05rem", lineHeight: 1.8 }}>
                Navigating the secondary property market requires strict procedural caution. Legends Marketing provides comprehensive file verification, NDC (No Demand Certificate) management, and official transfer execution.
              </p>
              <p>
            ...
            <div className="card" style={{ overflow: "hidden" }}>
              <img
                src="/images/services/resale.jpg"
                alt="Resale Assistance & File Transfer Illustration"
      ...
      <section className="section section--dark">
        <Container>
          <div className="cta-band text-center">
            ...
            <h2 style={{ color: "var(--white)" }}>Get Expert Advisory on Resale Assistance & File Transfer</h2>
