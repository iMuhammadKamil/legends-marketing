...
export const metadata: Metadata = {
  title: "Long-Term Investor Advisory | Legends Marketing",
  description:
    "Continuous wealth management, payment monitoring, and strategic exit execution for serious investors.",
};

const benefits = [
  "Dedicated senior consultant assigned to your portfolio",
  "Proactive installment reminders and ledger reconciliation",
  "Balloting participation and plot selection assistance",
  "Tax efficiency and capital gains planning guidance"
];
...
const processSteps = [
  {
    ...
    "desc": "Consolidate property files and define long-term yield milestones."
  },
  {
    "step": "02",
    "title": "Active Monitoring",
    "desc": "Quarterly construction progress checks and market valuation updates."
  },
  {
    "step": "03",
    "title": "Milestone Execution",
    "desc": "Assistance during map balloting, possession handover, and utility connections."
  },
  {
    "step": "04",
    "title": "Strategic Exit / Re-Investment",
    "desc": "Liquidation at peak market cycles to roll profits into higher-yield assets."
  }
];
        ...
        <Container>
          <div className="page-hero__inner">
            <span className="kicker" style={{ color: "var(--gold-light)" }}>
              Investor Services &middot; Dedicated Wealth Management
            </span>
            <h1 className="page-hero__title">Long-Term Investor Advisory</h1>
          ...
          <div className="grid-2" style={{ alignItems: "center", gap: "3.5rem" }}>
            <div>
              ...
              <p style={{ fontSize: "1.05rem", lineHeight: 1.8 }}>
                Real estate investment is a journey, not a single transaction. Our Long-Term Advisory service assigns you a dedicated senior consultant who monitors your property milestones, handles installment reminders, and advises on optimal exit timings.
              </p>
              <p>
            ...
            <div className="card" style={{ overflow: "hidden" }}>
              <img
                ...
                alt="Long-Term Investor Advisory Illustration"
      ...
      <section className="section section--dark">
        <Container>
          <div className="cta-band text-center">
            ...
            <h2 style={{ color: "var(--white)" }}>Get Expert Advisory on Long-Term Investor Advisory</h2>
